...
function UserSettings() {
    ...
    return (
        <div>
            <BottomNavigation value={selectedTab} onChange={handleTabChange} sx={{ backgroundColor: 'transparent' }}>
                <BottomNavigationAction
                    label="Info"
                    icon={<PersonIcon />}
                    sx={{
            ...
            {selectedTab === 0 && (
                <Card style={{ margin: '16px', borderRadius: 15, color: 'white', minWidth: '400px', width: '60vw' }}>
                    <CardContent>
                        <Typography variant="h4" gutterBottom>User name: {newName}</Typography>
                ...
                <Card style={{ margin: '16px', borderRadius: 15 }}>
                    <CardContent>
                        <FormControl component="fieldset">
                            ...
                            >
                                <FormControlLabel value="name" control={<Radio />} label="Change Name" />
                                <FormControlLabel value="email" control={<Radio />} label="Change Email" />
                                <FormControlLabel value="password" control={<Radio />} label="Change Password" />
                            </RadioGroup>
                        </FormControl>
